...
namespace ConsulSharpSample
{
    class Program
    {
        ...
        /// Create/UpdateKey
        /// </summary>
        public static void CreateUpdateKey()
        {
            var kvGovern = new KVGovern();
            var result = kvGovern.CreateUpdateKey(new CreateUpdateKeyParmeter { Key = "testkey1", DC = "dc2", Acquire = "a", Release = "b" }, "abc").GetAwaiter().GetResult();
            Console.WriteLine(EntityToString(result));
        }
        /// <summary>
        /// Delete Key
